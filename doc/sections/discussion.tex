...
We hope that this algorithm can unlock more complicated hidden Markov models with larger latent spaces for practitioners who have been unable to use them previously due to computational constraints.
