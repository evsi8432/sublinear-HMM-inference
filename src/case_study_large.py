...
# reduce storage
optim.data = "../../dat/Final_Data_Beth_fine.csv"
...
# save file
fname = "../params/case_study/case_study_large_K-%d-%d_%s_%.1f_%03d" % (K[0],K[1],method,partial_E,rand_seed)
